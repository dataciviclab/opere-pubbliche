...
if search and cup_input:
    ...
    if row.empty:
        ...
        c4.metric("Collaudati", fmt_num(int(r.get("anac_n_collaudati", 0))))

        c1, c2, c3 = st.columns(3)
        c1.metric("SAL", fmt_num(int(r.get("anac_n_sal", 0))))
        c2.metric("Importo SAL", fmt_eur(r.get("anac_importo_sal", 0)))
        c3.metric("SAL in ritardo", fmt_num(int(r.get("anac_sal_in_ritardo", 0))))
